...
namespace Kurir.CourierPages
{
    ...
    public partial class StartedDeliveriesListPage : ContentPage
    {
        ...
        public StartedDeliveriesListPage()
        {
            try
            {
        ...
        {
            var list = await deliveryService.GetStartedDeliveriesForCourier();
            if (list != null)
            {
